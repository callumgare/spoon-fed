...
<template>
	<div class="field">
		...
		<IconField>
			...
			<Password v-if="type === 'password'" :name="name" :placeholder="label" toggleMask :id="id" :disabled="disabled" />
			<InputText v-else :name="name" :type="type" :placeholder="label" :id="id" :disabled="disabled" />
		</IconField>
